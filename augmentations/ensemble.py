...
class Ensemble:
    ...
    def gen_obj_question(obj1,obj2,pos,adj1):
        q = self.templates.obj_recog_templates(adjective_obj(adj1,adj2,obj1,obj2))
        return (q,obj2)
    
    def gen_yes_or_no(obj1,obj2,pos,adj1,ans, adj2 = None):       
        q = self.templates.yes_or_no_templates(adjective_obj(adj1,adj2,obj1,obj2))        
        return (q,ans)
        
    def gen_pos_question(obj1,obj2,pos,adj1 = None, adj2 = None):                  
        q = self.templates.pos_templates(adjective_obj(adj1,adj2,obj1,obj2))
        return (q,pos)

    def gen_count_question(obj1, pos, obj2, count, adj1 = None, adj2 = None):
        q = self.templates.count_templates(adjective_obj(adj1,adj2,obj1,obj2))
        return (q, count)       
